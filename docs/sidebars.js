module.exports = {
  docs: [
    "Get-Started/welcome-to-kozmoai",
    {
      type: "category",
      label: "Get started",
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        "Integrations/integrations-langwatch",
        {
          ...
          label: 'Google',
          items: [
            'Integrations/Google/integrations-setup-google-oauth-kozmoai',
            'Integrations/Google/integrations-setup-google-cloud-vertex-ai-kozmoai',
          ],
        },
        {
          type: "category",
      ...
      items: [
        {
          type: "link",
          label: "Changelog",
          href: "https://github.com/digitranslab/kozmoai/releases/latest",
        },
      ],
    },
  ],
