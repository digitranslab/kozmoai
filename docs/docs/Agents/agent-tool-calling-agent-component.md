...
Create a problem-solving agent in Kozmoai, starting with the **Tool calling agent**.
...
class TextAnalyzerComponent(Component):
    ...
    documentation: str = "http://docs.kozmoai.org/components/custom"
    icon = "chart-bar"
...
Kozmoai supports **Tool Mode** for the following data types:
