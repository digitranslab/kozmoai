...
For example, the [Recursive character text splitter](https://github.com/digitranslab/kozmoai/blob/main/src/backend/base/kozmoai/components/langchain_utilities/recursive_character.py) is a child of the [LCTextSplitterComponent](https://github.com/digitranslab/kozmoai/blob/main/src/backend/base/kozmoai/base/textsplitters/model.py) class.
...
from kozmoai.base.textsplitters.model import LCTextSplitterComponent
from kozmoai.inputs.inputs import DataInput, IntInput, MessageTextInput
from kozmoai.utils.util import unescape_string
...
Kozmoai notifies you when a component's workspace version is behind the database version and an update is available.
