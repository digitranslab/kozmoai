...
We've chosen [Astra DB](https://astra.datastax.com/signup?utm_source=kozmoai-pre-release&utm_medium=referral&utm_campaign=kozmoai-announcement&utm_content=create-a-free-astra-db-account) as the vector database for this starter flow, but you can follow along with any of Kozmoai's vector database options.
