---
title: Integrate Composio with Kozmoai
slug: /integrations-composio
---

Kozmoai integrates with [Composio](https://docs.composio.dev/introduction/intro/overview) as a toolset for your **Agent** component.
...
## Connect Kozmoai to a Composio tool

1. In the Kozmoai **Workspace**, add an **Agent** component.
...
The **Auth Status** field changes to a ✅, which indicates the Kozmoai component is connected to your Composio account.
...
You have successfully integrated your Kozmoai component with Composio.
