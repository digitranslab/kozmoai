...
const config = {
  title: "Kozmoai Documentation",
  tagline:
    "Kozmoai is a low-code app builder for RAG and multi-agent AI applications.",
  favicon: "img/favicon.ico",
  url: "https://docs.kozmoai.org",
  baseUrl: "/",
  onBrokenLinks: "throw",
  onBrokenMarkdownLinks: "warn",
  onBrokenAnchors: "warn",
  organizationName: "digitranslab",
  projectName: "kozmoai",
  trailingSlash: false,
        ...
        redirects: [
          {
            to: "/",
            from: [
              "/whats-new-a-new-chapter-kozmoai",
              "/👋 Welcome-to-Kozmoai",
              "/getting-started-welcome-to-kozmoai",
              "/guides-new-to-llms"
            ],
          },
          {
  ...
  themeConfig:
    ...
    ({
      navbar: {
        ...
        logo: {
          alt: "Kozmoai",
          src: "img/kozmoai-logo-black.svg",
          srcDark: "img/kozmoai-logo-white.svg",
        },
        items: [
          // right
          {
          ...
          {
            position: "right",
            href: "https://twitter.com/kozmoai_ai",
