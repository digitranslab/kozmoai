"""Script to update Kozmoai starter projects with the latest component versions."""

import asyncio
import os

import kozmoai.main  # noqa: F401
...
async def main():
    ...
    Copies the code from kozmoai/initial_setup/setup.py. Doesn't use the
